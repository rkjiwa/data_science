...
# end::minimax-base-case[]
    ...
    candidate_move_options = game_state.legal_moves_hex(hexapawn.Player.o)[0]
    candidate_move_starting_pieces = game_state.legal_moves_hex(hexapawn.Player.o)[1]
...
class MinimaxAgent(Agent):
    def select_move(self, game_state):
        ...
        starting_points = game_state.legal_moves_hex(hexapawn.Player.o)[1]
        options = game_state.legal_moves_hex(hexapawn.Player.o)[0]
